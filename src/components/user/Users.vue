<template>
  <div>
    ...
    <!--分配角色对话框 -->
    <el-dialog title="分配角色" :visible.sync="setRoleVisibible" width="50%" @close="setRolesClosed">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="setRoleVisibible = false">取 消</el-button>
